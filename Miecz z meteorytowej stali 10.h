...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Mieczzmeteorytowejstali10
	/// </summary>
	public ref class Mieczzmeteorytowejstali10 : public System::Windows::Forms::Form
	{
	public:
		Mieczzmeteorytowejstali10(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Text = L"Obra¿enia: oparte na wybranym stylu\r\nSzansa na efekt krytyczny: Ból +45%\r\nSzansa "
				L"na efekt krytyczny: Rozbrojenie +20%";
			// 
			// label5
			// 
			...
			this->label2->Text = L"Miecz wykonany z trzech niebieskich kawa³ków meteorytowej stali. U¿ywany do walki"
				L" z ludŸmi. Nieskuteczny w walce z wiêkszoœci¹ potworów. U¿ywany w wied¿miñskich "
				L"stylach walki.";
			...
			this->Name = L"Mieczzmeteorytowejstali10";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Mieczzmeteorytowejstali10::Mieczzmeteorytowejstali10_Load);
...
#pragma endregion
	private: System::Void Mieczzmeteorytowejstali10_Load(System::Object^  sender, System::EventArgs^  e) {
				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Miecze stalowe\\meteoryt_blue (2).png");
	}
};
}
