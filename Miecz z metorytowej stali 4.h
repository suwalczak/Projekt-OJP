...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Mieczzmetorytowejstali4
	/// </summary>
	public ref class Mieczzmetorytowejstali4 : public System::Windows::Forms::Form
	{
	public:
		Mieczzmetorytowejstali4(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Text = L"Obra¿enia: +21%\r\nSzansa na efekt krytyczny: Ból, Og³uszenie i Precyzyjne trafieni"
				L"e +20%";
			// 
			// label5
			// 
			...
			this->label2->Text = L"Miecz wykonany z jednego czerwonego i dwóch ¿ó³tych kawa³ków meteorytowej stali. "
			...
			this->Name = L"Mieczzmetorytowejstali4";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Mieczzmetorytowejstali4::Mieczzmetorytowejstali4_Load);
...
#pragma endregion
	private: System::Void Mieczzmetorytowejstali4_Load(System::Object^  sender, System::EventArgs^  e) {
				 ///*this->pictureBox1->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.Image")));*/
				 /*toolStripButton1->Image = Bitmap::FromFile("meteoryt_red (2).png");*/
				 pictureBox1->Image = Bitmap::FromFile("meteoryt_red (2).png");
	}
};
}
