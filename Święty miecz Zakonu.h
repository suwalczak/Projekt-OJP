...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for ŒwiêtymieczZakonu
	/// </summary>
	public ref class ŒwiêtymieczZakonu : public System::Windows::Forms::Form
	{
	public:
		ŒwiêtymieczZakonu(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Size = System::Drawing::Size(201, 30);
			this->label7->TabIndex = 153;
			this->label7->Text = L"Œwiêty miecz Zakonu";
			// 
			// label6
			// 
			...
			this->label5->Text = L"Miecz jest w³asnoœci¹ Patryka z Weyze, zakonnego rycerza, którego mo¿esz zabiæ w "
				L"zadaniu \"Niebieskooka\".";
			// 
			// label4
			// 
			...
			this->Name = L"ŒwiêtymieczZakonu";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &ŒwiêtymieczZakonu::ŒwiêtymieczZakonu_Load);
...
#pragma endregion
	private: System::Void ŒwiêtymieczZakonu_Load(System::Object^  sender, System::EventArgs^  e) {

				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Miecze stalowe\\swiety_miecz_zakonu.png");
	}
};
}
