...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Runicznymiecz1
	/// </summary>
	public ref class Runicznymiecz1 : public System::Windows::Forms::Form
	{
	public:
		Runicznymiecz1(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Text = L"Obra¿enia: +15%\r\nSzansa na efekt krytyczny: Oœlepienie +25%\r\nSzansa na efekt kryt"
			...
			this->Name = L"Runicznymiecz1";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Runicznymiecz1::Runicznymiecz1_Load);
...
#pragma endregion
	private: System::Void Runicznymiecz1_Load(System::Object^  sender, System::EventArgs^  e) {

				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Miecze srebrne\\runa_green (1).png");
	}
};
}
