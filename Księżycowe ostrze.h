...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Ksiê¿ycoweostrze
	/// </summary>
	public ref class Ksiê¿ycoweostrze : public System::Windows::Forms::Form
	{
	public:
		Ksiê¿ycoweostrze(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Text = L"Ksiê¿ycowe ostrze";
			// 
			// label6
			// 
			...
			this->label5->Text = L"Mo¿esz otrzymaæ go w Akcie V od Wielkiego £owczego Królewskiego, jeœli w przeci¹g"
				L"u ca³ej gry przynios³eœ mu wszystkie dziesiêæ trofeów.";
			// 
			// label4
			// 
			...
			this->Name = L"Ksiê¿ycoweostrze";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Ksiê¿ycoweostrze::Ksiê¿ycoweostrze_Load);
...
#pragma endregion
	private: System::Void Ksiê¿ycoweostrze_Load(System::Object^  sender, System::EventArgs^  e) {
