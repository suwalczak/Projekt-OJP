...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Mieczzmeteorytowejstali9
	/// </summary>
	public ref class Mieczzmeteorytowejstali9 : public System::Windows::Forms::Form
	{
	public:
		Mieczzmeteorytowejstali9(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Text = L"Obra¿enia: +8%\r\nSzansa na efekt krytyczny: Ból +35%\r\nSzansa na efekt krytyczny: R"
				L"ozbrojenie i Precyzyjne trafienie +10%";
			// 
			// label5
			// 
			...
			this->label2->Text = L"Miecz wykonany z jednego ¿ó³tego i dwóch niebieskich kawa³ków meteorytowej stali."
				L" U¿ywany do walki z ludŸmi. Nieskuteczny w walce z wiêkszoœci¹ potworów. U¿ywany"
				L" w wied¿miñskich stylach walki.";
			...
			this->Name = L"Mieczzmeteorytowejstali9";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Mieczzmeteorytowejstali9::Mieczzmeteorytowejstali9_Load);
...
#pragma endregion
	private: System::Void Mieczzmeteorytowejstali9_Load(System::Object^  sender, System::EventArgs^  e) {
				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Miecze stalowe\\meteoryt_green (3).png");
	}
};
}
