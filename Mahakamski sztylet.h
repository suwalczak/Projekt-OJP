...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Mahakamskisztylet
	/// </summary>
	public ref class Mahakamskisztylet : public System::Windows::Forms::Form
	{
	public:
		Mahakamskisztylet(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Size = System::Drawing::Size(189, 30);
			this->label7->TabIndex = 297;
			this->label7->Text = L"Mahakamski sztylet";
			// 
			// label6
			// 
			...
			this->label5->Text = L"U¿ywaj¹ ich niektórzy krasnoludzcy bojownicy Wiewiórek.";
			// 
			// label4
			// 
			...
			this->Name = L"Mahakamskisztylet";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Mahakamskisztylet::Mahakamskisztylet_Load);
...
#pragma endregion
	private: System::Void Mahakamskisztylet_Load(System::Object^  sender, System::EventArgs^  e) {

				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Sztylety\\mahakamski_sztylet.png");
	}
};
}
