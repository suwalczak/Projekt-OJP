...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Text = L"Obra¿enia: +20%\r\nSzansa na efekt krytyczny: Ból +10%";
			// 
			// label5
			// 
			...
			this->label2->Text = L"Miecz wykonany z jednego niebieskiego i dwóch czerwonych kawa³ków meteorytowej st"
				L"ali. U¿ywany do walki z ludŸmi. Nieskuteczny w walce z wiêkszoœci¹ potworów. U¿y"
				L"wany w wied¿miñskich stylach walki.";
