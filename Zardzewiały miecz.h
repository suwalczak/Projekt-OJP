...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Zardzewia³ymiecz
	/// </summary>
	public ref class Zardzewia³ymiecz : public System::Windows::Forms::Form
	{
	public:
		Zardzewia³ymiecz(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Text = L"Zardzewia³y miecz stalowy";
			// 
			// label6
			// 
			...
			this->label5->Text = L"Miecz jest wbity w manekina na dziedziñcu Kaer Morhen. Jego wyjêcie jest twoim pi"
				L"erwszym celem w grze. PóŸniej mo¿na znaleŸæ go w wielu skrzyniach i przy wielu p"
			...
			this->Name = L"Zardzewia³ymiecz";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Zardzewia³ymiecz::Zardzewia³ymiecz_Load);
...
#pragma endregion
	private: System::Void Zardzewia³ymiecz_Load(System::Object^  sender, System::EventArgs^  e) {
