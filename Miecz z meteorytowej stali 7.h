...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Mieczzmeteorytowejstali7
	/// </summary>
	public ref class Mieczzmeteorytowejstali7 : public System::Windows::Forms::Form
	{
	public:
		Mieczzmeteorytowejstali7(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Text = L"Obra¿enia: +40%\r\nSzansa na efekt krytyczny: Krwawienie +30%";
			// 
			// label5
			// 
			...
			this->label2->Text = L"Miecz wykonany z trzech czerwonych kawa³ków meteorytowej stali. U¿ywany do walki "
				L"z ludŸmi. Nieskuteczny w walce z wiêkszoœci¹ potworów. U¿ywany w wied¿miñskich s"
				L"tylach walki.";
			...
			this->Name = L"Mieczzmeteorytowejstali7";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Mieczzmeteorytowejstali7::Mieczzmeteorytowejstali7_Load);
...
#pragma endregion
	private: System::Void Mieczzmeteorytowejstali7_Load(System::Object^  sender, System::EventArgs^  e) {
				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Miecze stalowe\\meteoryt_blue (1).png");
	}
};
}
