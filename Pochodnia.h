...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Pochodnia
	/// </summary>
	public ref class Pochodnia : public System::Windows::Forms::Form
	{
	public:
		Pochodnia(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Location = System::Drawing::Point(170, 9);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(106, 30);
			this->label7->TabIndex = 249;
			this->label7->Text = L"Pochodnia";
			// 
			// label6
			// 
			...
			this->label6->Text = L"Obra¿enia: 1-2\r\nSzansa na efekt krytyczny: Podpalenie +20%";
			// 
			// label5
			// 
			...
			this->label5->Text = L"Beczki, kufry - mo¿na j¹ znaleŸæ niemal¿e wszêdzie.";
			// 
			// label4
			// 
			...
			this->label2->Text = L"Pochodnia jako broñ nie jest stosowana w po³¹czeniu z wiedŸmiñskimi stylami walki"
				L".";
			...
			this->Name = L"Pochodnia";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Pochodnia::Pochodnia_Load);
...
#pragma endregion
	private: System::Void Pochodnia_Load(System::Object^  sender, System::EventArgs^  e) {

			pictureBox1->Image = Bitmap::FromFile("Grafika\\Broñ obuchowa\\pochodnia.png");
	}
};
}
