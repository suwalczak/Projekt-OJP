...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for WiedŸmiñskisrebrnymiecz
	/// </summary>
	public ref class WiedŸmiñskisrebrnymiecz : public System::Windows::Forms::Form
	{
	public:
		WiedŸmiñskisrebrnymiecz(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Size = System::Drawing::Size(260, 30);
			this->label7->TabIndex = 217;
			this->label7->Text = L"WiedŸmiñski srebrny miecz";
			// 
			// label6
			// 
			...
			this->label5->Text = L"Otrzymasz go na pocz¹tku zadania \"Wielka ucieczka\".";
			// 
			// label4
			// 
			...
			this->Name = L"WiedŸmiñskisrebrnymiecz";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &WiedŸmiñskisrebrnymiecz::WiedŸmiñskisrebrnymiecz_Load);
...
#pragma endregion
	private: System::Void WiedŸmiñskisrebrnymiecz_Load(System::Object^  sender, System::EventArgs^  e) {

				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Miecze srebrne\\wiedzminski_srebrny_miecz.png");
	}
};
}
