...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label5->Text = L"Mo¿na go znaleŸæ wœród zw³ok le¿¹cych na \"Wyspie Wywern\" na Bagnach; mo¿esz go ró"
				L"wnie¿ otrzymaæ od Sabriny Glevissig, za dostarczenie jej 20 porcji w¹troby besti"
				L"i (przygoda Cena neutralnoœci).";
			// 
			// label4
			// 
