...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for M³otbojowyzmutowanegorycerza
	/// </summary>
	public ref class M³otbojowyzmutowanegorycerza : public System::Windows::Forms::Form
	{
	public:
		M³otbojowyzmutowanegorycerza(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Size = System::Drawing::Size(326, 30);
			this->label7->TabIndex = 241;
			this->label7->Text = L"M³ot bojowy zmutowanego rycerza";
			// 
			// label6
			// 
			...
			this->label6->Text = L"Obra¿enia: 10-30\r\nSzansa na efekt krytyczny: Powalenie +70%";
			// 
			// label5
			// 
			this->label5->Font = (gcnew System::Drawing::Font(L"Sitka Display", 9.749999F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label5->Location = System::Drawing::Point(69, 229);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(311, 62);
			this->label5->TabIndex = 239;
			this->label5->Text = L"Nosz¹ je Bracia wiêksi, z którymi przyjdzie ci zmierzyæ siê pod koniec gry.";
			// 
			// label4
			// 
			...
			this->Name = L"M³otbojowyzmutowanegorycerza";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &M³otbojowyzmutowanegorycerza::M³otbojowyzmutowanegorycerza_Load);
...
#pragma endregion
	private: System::Void M³otbojowyzmutowanegorycerza_Load(System::Object^  sender, System::EventArgs^  e) {

				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Broñ obuchowa\\mlot_bojowy_zmutowanego_rycerza.png");
	}
};
}
