...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Mieczzmeteorytowejstali2
	/// </summary>
	public ref class Mieczzmeteorytowejstali2 : public System::Windows::Forms::Form
	{
	public:
		Mieczzmeteorytowejstali2(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Text = L"Obra¿enia: +16%\r\nSzansa na efekt krytyczny: Ból +30%\r\nSzansa na efekt krytyczny: "
				L"Og³uszenie i Precyzyjne trafienie +20%";
			// 
			// label5
			// 
			...
			this->label2->Text = L"Miecz wykonany z jednego niebieskiego i dwóch ¿ó³tych kawa³ków meteorytowej stali"
				L". U¿ywany do walki z ludŸmi. Nieskuteczny w walce z wiêkszoœci¹ potworów. U¿ywan"
				L"y w wied¿miñskich stylach walki.";
			...
			this->Name = L"Mieczzmeteorytowejstali2";
			this->Text = L"Weapons of Withcher";
			this->Load += gcnew System::EventHandler(this, &Mieczzmeteorytowejstali2::Mieczzmeteorytowejstali2_Load);
...
#pragma endregion
	private: System::Void Mieczzmeteorytowejstali2_Load(System::Object^  sender, System::EventArgs^  e) {
				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Miecze stalowe\\meteoryt_green.png");
	}
};
}
