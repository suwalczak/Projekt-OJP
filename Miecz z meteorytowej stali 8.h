...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Mieczzmeteorytowejstali8
	/// </summary>
	public ref class Mieczzmeteorytowejstali8 : public System::Windows::Forms::Form
	{
	public:
		Mieczzmeteorytowejstali8(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Text = L"Obra¿enia: +5%\r\nSzansa na efekt krytyczny: Ból +16%";
			// 
			// label5
			// 
			...
			this->label2->Text = L"Miecz wykonany z jednego czerwonego i dwóch niebieskich kawa³ków meteorytowej sta"
				L"li. U¿ywany do walki z ludŸmi. Nieskuteczny w walce z wiêkszoœci¹ potworów. U¿yw"
				L"any w wied¿miñskich stylach walki.";
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &Mieczzmeteorytowejstali8::pictureBox1_Click_1);
			// 
			// Mieczzmeteorytowejstali8
			// 
			...
			this->Name = L"Mieczzmeteorytowejstali8";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Mieczzmeteorytowejstali8::Mieczzmeteorytowejstali8_Load);
...
private: System::Void pictureBox1_Click_1(System::Object^  sender, System::EventArgs^  e) {
			 pictureBox1->Image = Bitmap::FromFile("meteoryt_green (2).png");
}
private: System::Void Mieczzmeteorytowejstali8_Load(System::Object^  sender, System::EventArgs^  e) {
			 pictureBox1->Image = Bitmap::FromFile("Grafika\\Miecze stalowe\\meteoryt_green (2).png");
}
};
}
