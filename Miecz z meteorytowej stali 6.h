...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Text = L"Obra¿enia: +28%\r\nSzansa na efekt krytyczny: Ból i Og³uszenie i Precyzyjne trafien"
				L"ie +10%";
			// 
			// label5
			// 
			...
			this->label2->Text = L"Miecz wykonany z jednego ¿ó³tego i dwóch czerwonych kawa³ków meteorytowej stali. "
