...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Bu³awa³añcuchowa
	/// </summary>
	public ref class Bu³awa³añcuchowa : public System::Windows::Forms::Form
	{
	public:
		Bu³awa³añcuchowa(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Location = System::Drawing::Point(116, 9);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(191, 30);
			this->label7->TabIndex = 225;
			this->label7->Text = L"Bu³awa ³añcuchowa";
			// 
			// label6
			// 
			...
			this->label6->Text = L"Obra¿enia: 7-15\r\nSzansa na efekt krytyczny: Og³uszenie +40%";
			// 
			// label5
			// 
			...
			this->label5->Text = L"Mo¿esz j¹ znaleŸæ przy cia³ach zabójców Salamandry, kiedy ju¿ siê z nimi rozprawi"
				L"sz.";
			// 
			// label4
			// 
			...
			this->Name = L"Bu³awa³añcuchowa";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Bu³awa³añcuchowa::Bu³awa³añcuchowa_Load);
...
#pragma endregion
	private: System::Void Bu³awa³añcuchowa_Load(System::Object^  sender, System::EventArgs^  e) {

				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Broñ obuchowa\\bulawa_lancuchowa.png");
	}
};
}
