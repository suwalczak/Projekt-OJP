...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for SztyletzDeithwen
	/// </summary>
	public ref class SztyletzDeithwen : public System::Windows::Forms::Form
	{
	public:
		SztyletzDeithwen(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// pictureBox1
			// 
			this->pictureBox1->Location = System::Drawing::Point(409, 66);
			...
			this->label7->Location = System::Drawing::Point(140, 9);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(179, 30);
			this->label7->TabIndex = 305;
			this->label7->Text = L"Sztylet z Deithwen";
			// 
			// label6
			// 
			...
			this->label6->Text = L"Obra¿enia: 2-8\r\nSzansa na efekt krytyczny: Ból +50%";
			// 
			// label5
			// 
			this->label5->Font = (gcnew System::Drawing::Font(L"Sitka Display", 9.749999F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label5->Location = System::Drawing::Point(69, 233);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(318, 59);
			this->label5->TabIndex = 303;
			this->label5->Text = L"U¿ywaj¹ ich niektórzy krasnoludzcy bojownicy Wiewiórek.Do kupienia u p³atnerza w "
				L"Wyzimie Handlowej oraz zakonnego zbrojmistrza w Starej Wyzimie.";
			// 
			// label4
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Sitka Display", 9.749999F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label3->Location = System::Drawing::Point(19, 233);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Sitka Display", 9.749999F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label2->Location = System::Drawing::Point(69, 52);
			...
			this->Name = L"SztyletzDeithwen";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &SztyletzDeithwen::SztyletzDeithwen_Load);
...
#pragma endregion
	private: System::Void SztyletzDeithwen_Load(System::Object^  sender, System::EventArgs^  e) {

				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Sztylety\\sztylet_z_deithwen.png");
	}
};
}
