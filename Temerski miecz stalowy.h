...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Temerskimieczstalowy
	/// </summary>
	public ref class Temerskimieczstalowy : public System::Windows::Forms::Form
	{
	public:
		Temerskimieczstalowy(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Text = L"Temerski miecz stalowy";
			// 
			// label6
			// 
			...
			this->label5->Text = L"Mo¿na go kupiæ lub znaleŸæ niemal¿e wszêdzie.";
			// 
			// label4
			// 
			...
			this->Name = L"Temerskimieczstalowy";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Temerskimieczstalowy::Temerskimieczstalowy_Load);
...
#pragma endregion
	private: System::Void Temerskimieczstalowy_Load(System::Object^  sender, System::EventArgs^  e) {

				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Miecze stalowe\\temerski_miecz_stalowy.png");
	}
};
}
