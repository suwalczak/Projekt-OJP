...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for KrasnoludzkitopórzGóryCarbon
	/// </summary>
	public ref class KrasnoludzkitopórzGóryCarbon : public System::Windows::Forms::Form
	{
	public:
		KrasnoludzkitopórzGóryCarbon(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Text = L"Krasnoludzki topór z Góry Carbon";
			// 
			// label6
			// 
			...
			this->label5->Text = L"Mo¿na go znaleŸæ w kryjówce króla Radowida, w Wyzimie Handlowej; do kupienia równ"
				L"ie¿ u zbrojmistrza Scoia\'tael w Starej Wyzimie (o ile wspierasz Wiewiórki).";
			// 
			// label4
			// 
			...
			this->Name = L"KrasnoludzkitopórzGóryCarbon";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &KrasnoludzkitopórzGóryCarbon::KrasnoludzkitopórzGóryCarbon_Load);
...
#pragma endregion
	private: System::Void KrasnoludzkitopórzGóryCarbon_Load(System::Object^  sender, System::EventArgs^  e) {
