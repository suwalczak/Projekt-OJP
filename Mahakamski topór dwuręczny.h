...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Mahakamskitopórdwurêczny
	/// </summary>
	public ref class Mahakamskitopórdwurêczny : public System::Windows::Forms::Form
	{
	public:
		Mahakamskitopórdwurêczny(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// pictureBox1
			// 
			this->pictureBox1->Location = System::Drawing::Point(394, 66);
			...
			this->label7->Location = System::Drawing::Point(69, 9);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(283, 30);
			this->label7->TabIndex = 273;
			this->label7->Text = L"Mahakamski topór dwurêczny";
			// 
			// label6
			// 
			...
			this->label6->Text = L"Obra¿enia: 9-27\r\nSzansa na efekt krytyczny: Krwawienie +60%";
			// 
			// label5
			// 
			this->label5->Font = (gcnew System::Drawing::Font(L"Sitka Display", 9.749999F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label5->Location = System::Drawing::Point(70, 219);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(318, 77);
			this->label5->TabIndex = 271;
			this->label5->Text = L"Mo¿na go znaleŸæ w sarkofagu, w krypcie na Brzegu; do kupienia równie¿ u p³atnerz"
				L"a w Wyzimie Handlowej, u syna p³atnerza we wsi Odmêty i u zbrojmistrza Scoia\'tae"
				L"l w Starej Wyzimie.";
			// 
			// label4
			// 
			...
			this->Name = L"Mahakamskitopórdwurêczny";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Mahakamskitopórdwurêczny::Mahakamskitopórdwurêczny_Load);
...
#pragma endregion
	private: System::Void Mahakamskitopórdwurêczny_Load(System::Object^  sender, System::EventArgs^  e) {

				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Topory\\mahakamski_topor_dwureczny.png");
	}
};
}
