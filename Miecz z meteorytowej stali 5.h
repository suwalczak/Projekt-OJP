...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Mieczzmeteorytowejstali5
	/// </summary>
	public ref class Mieczzmeteorytowejstali5 : public System::Windows::Forms::Form
	{
	public:
		Mieczzmeteorytowejstali5(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Size = System::Drawing::Size(353, 66);
			this->label6->TabIndex = 80;
			this->label6->Text = L"Obra¿enia: +24%\r\nSzansa na efekt krytyczny: Ból i Og³uszenie +30%\r\nSzansa na efek"
				L"t krytyczny: Oœlepienie i Precyzyjne trafienie +30%";
			// 
			// label5
			// 
			...
			this->label2->Text = L"Miecz wykonany z trzech ¿ó³tych kawa³ków meteorytowej stali. U¿ywany do walki z l"
				L"udŸmi. Nieskuteczny w walce z wiêkszoœci¹ potworów. U¿ywany w wied¿miñskich styl"
				L"ach walki.";
			...
			this->Name = L"Mieczzmeteorytowejstali5";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Mieczzmeteorytowejstali5::Mieczzmeteorytowejstali5_Load);
...
#pragma endregion
	private: System::Void Mieczzmeteorytowejstali5_Load(System::Object^  sender, System::EventArgs^  e) {
				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Miecze stalowe\\meteoryt_green (1).png");
	}
};
}
