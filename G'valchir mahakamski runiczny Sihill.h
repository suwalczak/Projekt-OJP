...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for GvalchirmahakamskirunicznySihill
	/// </summary>
	public ref class GvalchirmahakamskirunicznySihill : public System::Windows::Forms::Form
	{
	public:
		GvalchirmahakamskirunicznySihill(void)
		{
			InitializeComponent();
			//
	...
	protected:
		...
		/// </summary>
		~GvalchirmahakamskirunicznySihill()
		{
			if (components)
			{
				delete components;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(GvalchirmahakamskirunicznySihill::typeid));
			...
			this->label7->Location = System::Drawing::Point(68, 9);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(354, 30);
			this->label7->TabIndex = 38;
			this->label7->Text = L"G\'valchir: mahakamski runiczny Sihill";
			// 
			// label6
			// 
			...
			this->label5->Size = System::Drawing::Size(311, 80);
			this->label5->TabIndex = 36;
			this->label5->Text = L"Otrzymasz go w Akcie V od Zahina Schmartza; w³aœcicielem drugiego egzemplarza jes"
				L"t kpt. Jean Pierre; mo¿liwe jest równie¿, ¿e miecz otrzymasz w Akcie V od Wielki"
				L"ego £owczego Królewskiego.";
			// 
			// label4
			// 
			...
			this->Name = L"GvalchirmahakamskirunicznySihill";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &GvalchirmahakamskirunicznySihill::GvalchirmahakamskirunicznySihill_Load);
...
#pragma endregion
	private: System::Void GvalchirmahakamskirunicznySihill_Load(System::Object^  sender, System::EventArgs^  e) {
				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Miecze stalowe\\sihill.png");
	}
};
}
