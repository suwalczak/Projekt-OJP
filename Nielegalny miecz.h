...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Nielegalnymiecz
	/// </summary>
	public ref class Nielegalnymiecz : public System::Windows::Forms::Form
	{
	public:
		Nielegalnymiecz(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Location = System::Drawing::Point(150, 9);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(164, 30);
			this->label7->TabIndex = 137;
			this->label7->Text = L"Nielegalny miecz";
			// 
			// label6
			// 
			...
			this->label6->Text = L"Obra¿enia: -20%\r\nSzansa na efekt krytyczny: Ból, Oslepienie i \r\nPrecyzyjne trafie"
				L"nie +30%";
			// 
			// label5
			// 
			...
			this->label5->Text = L"Takich mieczy u¿ywaj¹ najemnicy Salamandry, którzy sami bêd¹ ci siê rzucaæ pod os"
				L"trze przez prawie ca³¹ grê.";
			// 
			// label4
			// 
			...
			this->Name = L"Nielegalnymiecz";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Nielegalnymiecz::Nielegalnymiecz_Load);
...
#pragma endregion
	private: System::Void Nielegalnymiecz_Load(System::Object^  sender, System::EventArgs^  e) {

				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Miecze stalowe\\nielegalny_miecz.png");
	}
};
}
