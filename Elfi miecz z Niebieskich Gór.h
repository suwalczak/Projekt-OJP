...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for ElfimieczzNiebieskichGór
	/// </summary>
	public ref class ElfimieczzNiebieskichGór : public System::Windows::Forms::Form
	{
	public:
		ElfimieczzNiebieskichGór(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(ElfimieczzNiebieskichGór::typeid));
			...
			this->label7->Text = L"Elfi miecz z Niebieskich Gór";
			// 
			// label6
			// 
			...
			this->label5->Text = L"Takimi mieczami walcz¹ niektóre Elfy, które mo¿na spotkaæ na ulicach Starej Wyzim"
				L"y w Akcie V. Oczywiœcie, wczeœniej trzeba bêdzie skróciæ o g³owê posiadacza bron"
				L"i.";
			// 
			// label4
			// 
			...
			this->Name = L"ElfimieczzNiebieskichGór";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &ElfimieczzNiebieskichGór::ElfimieczzNiebieskichGór_Load);
...
#pragma endregion
	private: System::Void ElfimieczzNiebieskichGór_Load(System::Object^  sender, System::EventArgs^  e) {
