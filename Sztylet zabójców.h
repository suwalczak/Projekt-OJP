...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Sztyletzabójców
	/// </summary>
	public ref class Sztyletzabójców : public System::Windows::Forms::Form
	{
	public:
		Sztyletzabójców(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// pictureBox1
			// 
			this->pictureBox1->Location = System::Drawing::Point(408, 66);
			...
			this->label7->Size = System::Drawing::Size(161, 30);
			this->label7->TabIndex = 313;
			this->label7->Text = L"Sztylet zabójców";
			// 
			// label6
			// 
			...
			this->label6->Text = L"Obra¿enia: 1-7\r\nSzansa na efekt krytyczny: Ból +45%\r\nSzansa na efekt krytyczny: T"
				L"rucizna +18%";
			// 
			// label5
			// 
			...
			this->label5->Text = L"Tych sztyletów u¿ywaj¹ zabójcy Salamandry, których spotkasz na swojej drodze co n"
				L"ajmniej kilka razy.";
			// 
			// label4
			// 
			...
			this->Name = L"Sztyletzabójców";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Sztyletzabójców::Sztyletzabójców_Load);
...
#pragma endregion
	private: System::Void Sztyletzabójców_Load(System::Object^  sender, System::EventArgs^  e) {

				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Sztylety\\sztylet_zabojcow.png");
	}
};
}
