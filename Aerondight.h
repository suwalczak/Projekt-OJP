...
namespace Projekt_OJP {
	...
	/// <summary>
	/// Summary for Aerondight
	/// </summary>
	public ref class Aerondight : public System::Windows::Forms::Form
	{
	public:
		Aerondight(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Location = System::Drawing::Point(151, 9);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(114, 30);
			this->label7->TabIndex = 185;
			this->label7->Text = L"Aerondight";
			// 
			// label6
			// 
			...
			this->label6->Text = L"Obra¿enia: +60%\r\nAtak: +10%\r\nSzansa na efekt krytyczny: Ból, Oœlepienie, Podpalen"
				L"ie i \r\nPrecyzyjne trafienie +50%";
			// 
			// label5
			// 
			this->label5->Font = (gcnew System::Drawing::Font(L"Sitka Display", 9.749999F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label5->Location = System::Drawing::Point(67, 229);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(311, 44);
			this->label5->TabIndex = 183;
			this->label5->Text = L"Otrzymasz go od Pani Jeziora, po ukoñczeniu zadania \"Œcie¿ki przeznaczenia\".";
			// 
			// label4
			// 
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Sitka Display", 9.749999F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label4->Location = System::Drawing::Point(17, 148);
			...
			this->Name = L"Aerondight";
			this->Text = L"Weapons of Witcher";
			this->Load += gcnew System::EventHandler(this, &Aerondight::Aerondight_Load);
...
#pragma endregion
	private: System::Void Aerondight_Load(System::Object^  sender, System::EventArgs^  e) {

				 pictureBox1->Image = Bitmap::FromFile("Grafika\\Miecze srebrne\\aerondight.png");
	}
};
}
